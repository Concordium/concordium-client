...
- Updated the client to validate token initialization parameters according
  the adjustments to the PLT speficication <https://proposals.concordium.com/CIS/cis-7.html>
  where token name, metadata and governance account are optional in the token module interface
